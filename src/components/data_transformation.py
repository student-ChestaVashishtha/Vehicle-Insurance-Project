...
class DataTransformation:
    ...
    def get_data_transformer(self):
        ...
        try:
            ...
            preprocessor=ColumnTransformer(transformers=[("Standard_Scaling", numeric_transformer,num_features),
                                                         ("MinMax_Scaling",minmax_scaler,mm_features)],remainder="passthrough")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        try:
            ...
            logging.info("Saving transformed object and files")
